...
for user in data_dict:
    ...
    if value == 'NaN':
        continue
    oldStock.append(value)
print "Max value in data:" + str(max(oldStock))
print "Min value in data:" + str(min(oldStock))
...
for user in data_dict:
    ...
    if value == 'NaN':
        continue
    salaryStock.append(value)
print "Max value for salary in data:" + str(max(salaryStock))
print "Min value for salary in data:" + str(min(salaryStock))
