...
print "data for 154: " + str(word_data[152])
...
transformer = TfidfVectorizer(stop_words="english", lowercase=True)
transformer.fit_transform(word_data)

print "size of Matriz tfid names: " + str(len(transformer.get_feature_names()))
print "feature name :" + str(transformer.get_feature_names()[34597])
