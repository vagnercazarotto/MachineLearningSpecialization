...
data2 = featureFormat(dictionary,features_list2,remove_all_zeroes=True)
...
print "Score for wrong dataset: " + str(reg.score(feature_train,target_train)) 
print "Score for real dataset" + str(reg.score(feature_test,target_test))


reg2 = linear_model.LinearRegression()
reg2.fit(feature_train2,target_train2)
print "Regression score for Long Term Incentive: " + str(reg2.score(feature_test2,target_test2))
